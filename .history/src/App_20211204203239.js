...
function App() {
  ...
  return (
    <main>
      ...
      <Dashboard arePlanets={arePlanets} setIsSorted={setIsSorted} setSortedBodies={setSortedBodies} bodies={arePlanets ? bodies.bodies.filter(body => body.isPlanet) : bodies.bodies} showPlanets={showPlanets} showBodies={showBodies} toggleSearchInput={toggleSearchInput}/>
