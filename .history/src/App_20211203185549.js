...
function App() {
  ...
  return (
    <main>
      ...
      <BodiesTable loading={loading} searchingBodies={searchingBodies} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} bodies={arePlanets ? bodies.bodies.filter(body => body.isPlanet) : bodies.bodies}/>
    </main>
  );
}
