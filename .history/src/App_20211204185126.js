...
function App() {
  ...
  return (
    <main>
      ...
      <BodiesTable loading={loading} searchingBodies={sortType ? sortedBodies : searchingBodies} bodies={arePlanets ? bodies.bodies.filter(body => body.isPlanet) : bodies.bodies}/>
    </main>
  );
}
