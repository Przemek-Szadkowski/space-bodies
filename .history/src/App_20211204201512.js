...
function App() {
  ...
  const [sortedBodies, setSortedBodies] = useState(null);
  ...
  return (
    <main>
      ...
      <Dashboard arePlanets={arePlanets} setSortedBodies={setSortedBodies} bodies={arePlanets ? bodies.bodies.filter(body => body.isPlanet) : bodies.bodies} showPlanets={showPlanets} toggleSearchInput={toggleSearchInput}/>
