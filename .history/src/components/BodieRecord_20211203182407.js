...
export default function BodieRecord(props) {
    ...
    const handleRecordClick = () => {
        // refInput.current.parentNode.classList.toggle('open');
        // refInput.current.classList.add('active');
        refInput.current.style.flexBasis = '44%';
        refInput.current.style.height = '44%';
    };
