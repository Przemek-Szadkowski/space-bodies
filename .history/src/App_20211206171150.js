...
function App() {
  ...
  return (
    <main>
      ...
      <Dashboard arePlanets={arePlanets} bodies={arePlanets ? bodies.bodies.filter(body => body.isPlanet) : bodies.bodies} showPlanets={toggleBodies} toggleSearchInput={toggleSearchInput}/>
